...
public interface ICartService {
     ...
     */
    Cart addItemToCartForPrincipal(org.springframework.security.core.userdetails.User springSecurityUser, AddItemToCartRequest request);

    /**
     * Met à jour un article du panier pour l'utilisateur associé au principal Spring Security.
     */
    Cart updateCartItemForPrincipal(org.springframework.security.core.userdetails.User springSecurityUser, Long itemId, UpdateCartItemRequest request);

    /**
     * Supprime un article du panier pour l'utilisateur associé au principal Spring Security.
     */
    void removeItemFromCartForPrincipal(org.springframework.security.core.userdetails.User springSecurityUser, Long itemId);
