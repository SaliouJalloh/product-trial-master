...
public interface IWishlistItemStorageMapper {
  ...
  WishlistItem toModel(
      WishlistItemEntity entity,
  ...
  WishlistItemEntity toEntity(
      WishlistItem model,
      @Context CycleAvoidingMappingContext context); // Type de paramètre mis à jour

  // Cette méthode mapProduct n'est plus strictement nécessaire si le mapping product.id ->
